...
// Accessors for new parameters
uint32_t ConfigValues::getMaxOverallMemory() const { return maxOverallMemory; }
uint32_t ConfigValues::getMemoryPerFrame() const { return memoryPerFrame; }
uint32_t ConfigValues::getMinMemPerProc() const { return minMemPerProc; }
uint32_t ConfigValues::getMaxMemPerProc() const { return maxMemPerProc; }

uint32_t ConfigValues::getNCPU() const { return nCPU; }
